import { EVENT_PHASES_ENUM } from './constants';
...
export class Event {
   ...
   **/
  static readonly NONE = EVENT_PHASES_ENUM.NONE;

  /**
   * @static
   * @property {number} CAPTURING_PHASE - The CAPTURING_PHASE constant.
   **/
  static readonly CAPTURING_PHASE = EVENT_PHASES_ENUM.CAPTURING;

  /**
   * @static
   * @property {number} AT_TARGET - The AT_TARGET constant.
   **/
  static readonly AT_TARGET = EVENT_PHASES_ENUM.AT_TARGET;

  /**
   * @static
   * @property {number} BUBBLING_PHASE - The BUBBLING_PHASE constant.
   **/
  static readonly BUBBLING_PHASE = EVENT_PHASES_ENUM.BUBBLING;

  /**
   * @property {number} NONE - The NONE constant.
   **/

  readonly NONE = EVENT_PHASES_ENUM.NONE;

  /**
   * @property {number} CAPTURING_PHASE - The CAPTURING_PHASE constant.
   **/
  readonly CAPTURING_PHASE = EVENT_PHASES_ENUM.CAPTURING;

  /**
   * @property {number} AT_TARGET - The AT_TARGET constant.
   **/
  readonly AT_TARGET = EVENT_PHASES_ENUM.AT_TARGET;

  /**
   * @property {number} BUBBLING_PHASE - The BUBBLING_PHASE constant.
   **/
  readonly BUBBLING_PHASE = EVENT_PHASES_ENUM.BUBBLING;
   ...
   * @returns {0|2}
   */
  get eventPhase(): typeof EVENT_PHASES_ENUM.NONE | typeof EVENT_PHASES_ENUM.AT_TARGET {
    return this.#internalData.dispatchFlag ? EVENT_PHASES_ENUM.AT_TARGET : EVENT_PHASES_ENUM.NONE;
  }
